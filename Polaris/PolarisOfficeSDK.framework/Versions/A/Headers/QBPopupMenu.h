...
@property int maxItemCountInPage;

+ (instancetype)popupMenuWithItems:(NSArray *)items;
- (instancetype)initWithItems:(NSArray *)items;

- (void)showInView:(UIView *)view targetRect:(CGRect)targetRect heightOffset:(int)offsetY widthOffset:(int)offsetX animated:(BOOL)animated;
